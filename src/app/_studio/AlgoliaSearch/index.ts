...
export * from "./AlgoliaSearchComponent";

export const AlgoliaSearchDefinition: ComponentDefinition = {
  id: "algolia-search",
  name: "Algolia Search",
  thumbnailUrl:
    "https://logosandtypes.com/wp-content/uploads/2023/11/algolia.svg",
